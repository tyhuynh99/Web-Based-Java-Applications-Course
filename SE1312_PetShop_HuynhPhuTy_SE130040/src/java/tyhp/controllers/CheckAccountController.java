...
public class CheckAccountController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bean.checkLogin().equalsIgnoreCase("user")) {
                request.setAttribute("SHOW", "TRUE");
            } else if (bean.checkLogin().equalsIgnoreCase("admin")) {
                request.setAttribute("INVALID", "Only user have pet, please try again");
            } else {
                request.setAttribute("INVALID", "Username or password is incorrect");
            }
        } catch (Exception e) {
            log("ERROR at CheckAccountController: " + e.getMessage());
        } finally {
