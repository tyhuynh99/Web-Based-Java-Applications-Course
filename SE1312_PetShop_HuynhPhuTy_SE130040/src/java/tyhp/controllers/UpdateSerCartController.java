 ...
 * @author ACER
 */
public class UpdateSerCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (serCartBean.update() == true) {
                String key = serId+"-"+petId;
                serCartMap.replace(key, serCartDto);
                request.setAttribute("SER_MESS", "UPDATE SUCCESSFUL");
            } else {
                request.setAttribute("SER_MESS", "UPDATE FAIL");
            }
        } catch (Exception e) {
            e.printStackTrace();
            log("ERROR at UpdateSerCartController: " + e.getMessage());
        } finally {
