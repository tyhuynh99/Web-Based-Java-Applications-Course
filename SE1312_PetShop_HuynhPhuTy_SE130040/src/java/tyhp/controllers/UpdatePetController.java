    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bean.update() == true) {
                ...
                request.setAttribute("UPDATE_FAILED", "Update failed");
            }
        } catch (Exception e) {
            log("ERROR at UpddatePetController: " + e.getMessage());
        } finally {
            request.getRequestDispatcher("PetDetailController").forward(request, response);
        }
    }
